...
{ 
    ...
    public void Interact(PlayerInteraction interaction) { Interact(); }
    ...
    public bool CanHold(out float time) { time = 0; return false; }
    public Action GetOnDropEvent() { return null; }
}
